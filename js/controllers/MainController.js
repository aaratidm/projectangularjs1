app.controller('login-ctrl', function($scope) {
    ...
    $scope.API_KEY = 'AIzaSyBSAEG6LiSyGyaAJvYHpHxMqqo2dBOXdpE'
    $scope.CLIENT_ID = '521958382623-gjhcs90n39qdqls27v4805la19114hs4.apps.googleusercontent.com';
     ...
     */
    $scope.updateSigninStatus = function updateSigninStatus(isSignedIn) {
      if (isSignedIn) {
     ...
     */
    $scope.handleAuthClick=function handleAuthClick() {
     ...
     */
    $scope.handleSignoutClick=function handleSignoutClick(event) {
    ...
    $scope.listMajors=function() {
      document.write("Listing listMajors");
    }
    /**
    ...
    /*function listMajors() {
      ...
      $scope.handleSignoutClick();
      $scope.updateSigninStatus();
      $scope.appendPre();
      }); 
